...
def preprocess_point_cloud(pcd, voxel_size):
    ...
    pcd_down_normals = o3d.geometry.estimate_normals(pcd, o3d.geometry.KDTreeSearchParamHybrid(radius=radius_normal, max_nn=30))
...
def prepare_dataset(voxel_size):
    ...
    target = o3d.io.read_point_cloud(source_path, format="ply")
...
def execute_global_registration(source_down, target_down, source_fpfh,
    ...
    # result = o3d.registration.registration_ransac_based_on_feature_matching(source_down, target_down, source_fpfh, target_fpfh,
    #     distance_threshold,[o3d.registration.CorrespondenceCheckerBasedOnDistance(distance_threshold)], 
