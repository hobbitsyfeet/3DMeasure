...
def main():
    ...
    object_path, object_format = get_file() 
    scene_path, scene_format = get_file()
    object = pcl.load(object_path)
    scene = pcl.load(scene_path)
    ...
    nest = scene.make_NormalEstimation()
