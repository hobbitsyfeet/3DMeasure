...
def make_ConcaveHull(pcl_cloud):
    ...
    if cloud_hull.size != 0:
        pcl.save(cloud_hull, '_test_hull.pcd')



    return cloud_hull

# def make_ConvexHull(pcl_cloud):
#     proj = pcl_cloud.make_ProjectInliers()
#     proj.set_model_type(pcl.SACMODEL_PLANE)

#     pcl_cloud = proj.filter()

#     chull = pcl_cloud.make_ConvexHull()
#     chull.set_Alpha(0.01)
#     cloud_hull = chull.reconstruct()
